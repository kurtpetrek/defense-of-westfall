...
DefenseOfWestfall.Game.prototype = {
    ...
    create: function() {
        ...
        this.cavalryPrompt;
        this.buildKnight();
        this.moreSkeletonRate = 20000;
        this.moreSkeletonFire = 3000;
        this.moreTrollRate = 37000;
        this.moreTrollFire = 1000;
    ...
    buildWarPanel: function() {
        this.cavalryButton = this.add.button(this.world.centerX - 70, this.world.height-200, 'cavalry', this.buildCavalry, this, 2, 1, 0);
       ...
       // this.archerButton = this.add.button(this.world.centerX - 220, this.world.height-100, 'archerFacingSouth', this.archerButtonActive, this, 2, 1, 0);
        this.dwarfButton = this.add.button(this.world.centerX + 150, this.world.height-200, 'dwarfRunningEast', this.dwarfButtonActive, this, 2, 1, 0);
    },
...
// !!!!! GAme OVER !!!!!!      
        ...
        this.skeletonsKilledPrompt.text = "";
            ...
            this.gameOverMessage = this.add.bitmapText(this.world.centerX - 230, this.world.centerY - 400, 'eightbitwonder', 'The wall\n\n' + 'has fallen!', 50);
            this.gameOverMessage.align = "center";
             ...
             this.highScoreMessage = this.add.bitmapText(this.world.centerX - 150, this.world.centerY - 100, 'eightbitwonder', 'Civilians \n\n' + "Saved \n\n" + Math.floor(this.peopleSaved), 40);
            this.highScoreMessage.align = "center";
             ...
             this.highSkeletonScoreMessage = this.add.bitmapText(this.world.centerX - 180, this.world.centerY + 200, 'eightbitwonder', 'Skeletons \n\n' + 'killed \n\n' + this.totalSkeletonsKilled, 40);
     ...
     /*   this.music.onStop.addOnce(function() {
        ...
        if(this.gameOver == false){
            if(this.time.now > this.wizardLaunchFire){
                ...
                this.wizardKillTime = this.time.now + 4000;
                this.spellSound.play();
                this.spellSound.volume = 0.4;
                this.wizardMan = this.add.sprite(this.world.centerX, 890, 'wizard','wizard01');
            this.wizardMan.anchor.setTo(0.5, 0.5);
                this.wizardMan.scale.x *= 1.5;
                this.wizardMan.scale.y *= 1.5;
            this.wizardMan.animations.add('spelling', this.game.math.numberArray(1,12));
            this.wizardMan.animations.play('spelling', 24, true);
            }

            if(this.time.now < this.wizardLaunchFire - this.wizardLaunchRate + 600){
                var t = this.wizardFireGroup.create(this.world.centerX, 885, 'explosionA', 'explosion01.png');
                this.physics.enable(t, Phaser.Physics.ARCADE);
                    t.enableBody = true;
                    t.anchor.setTo(0.5, 0.5);
                    t.body.moves = true;
                    t.animations.add('fire', this.game.math.numberArray(1,16));
                    t.animations.play('fire', 10, true);
            ...
            if(this.time.now > this.wizardKillTime){
                this.wizardKillTime = this.time.now + 2000;
                this.wizardMan.kill();
